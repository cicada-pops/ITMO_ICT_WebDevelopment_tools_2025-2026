...
Репозиторий с лабораторными работами по курсу *Web Development Tools (2025–2026)*.

## Лабораторные работы

- [Лабораторная работа №1 — Система проведения хакатонов](lr_1/index.md)
- [Лабораторная работа №2 — Потоки, процессы, асинхронность](lr_2/index.md)
- [Лабораторная работа №3 — Docker, парсер, очередь Celery](lr_3/index.md)
